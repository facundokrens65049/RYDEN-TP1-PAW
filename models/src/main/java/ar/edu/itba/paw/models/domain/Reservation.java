...
public final class Reservation {
     ...
     * {@link ***REMOVED***CANCELLED} remains for reservations cancelled before granular reasons existed.
     */
    public enum Status {
        PENDING,
        ACCEPTED,
    ...
    /**
     * Any terminal cancellation status, including legacy {@link Status***REMOVED***CANCELLED}.
     */
