...
public final record DualLayerPageWindow(
    ...
    /** Slice one DB batch using {@link ***REMOVED***innerSliceStart()} and {@link ***REMOVED***uiPageSize()}. */
    ...
    /** Slice a full in-memory ordered list using {@link ***REMOVED***globalFirstIndex()} and {@link ***REMOVED***uiPageSize()}. */
