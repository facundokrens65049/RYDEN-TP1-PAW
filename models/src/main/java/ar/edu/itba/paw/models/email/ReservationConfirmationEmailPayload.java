 ...
 * Rider copy uses {@link ***REMOVED***getMessageLocale()}; owner copy uses {@link ***REMOVED***getOwnerMailLocale()}.
 * <p>
 * Built with {@link ***REMOVED***builder()} to avoid long constructor parameter lists.
 */
public final class ReservationConfirmationEmailPayload {
     ...
     * After proof (second email): full address including number, see {@code ListingService***REMOVED***formatRiderReservationHandoverSummary}.
     */
