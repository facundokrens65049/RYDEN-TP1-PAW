...
/**
 * Immutable search filters + paging (Item 17). Prefer {@link ***REMOVED***builder()} (Item 2); in the web app, wire sizes from
...
public final class ListingSearchCriteria {
    ...
    public static final class Builder {
        ...
        private int page;
        /** {@code 0} means use {@link PaginationFallbackSizes***REMOVED***UI_PAGE_SIZE} at {@link ***REMOVED***build()}. */
        private int uiPageSize;
        /** {@code 0} means use {@link PaginationFallbackSizes***REMOVED***DB_FETCH_SIZE} at {@link ***REMOVED***build()}. */
    ...
    /** Rows fetched per DB query window (e.g. 24); must be ≥ {@link ***REMOVED***getUiPageSize()}. */
