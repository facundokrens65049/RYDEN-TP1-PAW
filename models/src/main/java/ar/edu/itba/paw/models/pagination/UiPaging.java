...
public final class UiPaging {
    ...
    /** Same rule as {@code Page***REMOVED***getTotalPages()} for non-empty page size. */
    ...
    /**
     * Clamps a requested 0-based page to {@code [0, totalPages - 1]} using the same total page count as {@link ***REMOVED***totalPages}.
     */
