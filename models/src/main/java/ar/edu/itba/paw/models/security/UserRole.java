...
public enum UserRole {
    ...
    /**
     * Exact value written to / read from {@code user_roles.role} (matches {@link ***REMOVED***name()} for current roles).
     */
    ...
    /**
     * Resolves a row from {@code user_roles.role}; trimming and ASCII-uppercase matching {@link ***REMOVED***name()}.
     */
