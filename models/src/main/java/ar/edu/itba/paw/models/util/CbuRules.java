...
/**
 * Central definition of CBU format for payouts. If the banking standard changes length, update {@link ***REMOVED***REQUIRED_DIGIT_LENGTH} once.
 */
public final class CbuRules {
    ...
    /**
     * @return {@code true} when {@code cbuRaw} is non-null and its trim is exactly {@link ***REMOVED***REQUIRED_DIGIT_LENGTH} decimal digits.
     */
