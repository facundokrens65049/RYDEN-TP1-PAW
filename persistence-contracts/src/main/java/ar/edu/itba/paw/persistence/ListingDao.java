...
public interface ListingDao {
    ...
    /**
     * Ordered window for public browse (cheapest first). Caller composes UI pagination with {@link ***REMOVED***countBrowseEligibleActiveListings}.
     */
    List<ListingCard> getCheapestListingCardsWindow(int offset, int limit, LocalDate browseWallDate, Long excludeOwnerUserId);

    /**
     * Ordered window for public browse (newest first). Caller composes UI pagination with {@link ***REMOVED***countBrowseEligibleActiveListings}.
     */
