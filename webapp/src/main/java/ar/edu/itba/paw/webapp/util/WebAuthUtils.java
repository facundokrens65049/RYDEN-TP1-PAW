...
public final class WebAuthUtils {
    ...
    /**
     * Domain user injected with {@link ar.edu.itba.paw.webapp.support.CurrentUser} (and exposed in the model by {@link ar.edu.itba.paw.webapp.advice.LoggedUserAdvice} when signed in); same contract as {@link ***REMOVED***requireCurrentUser(Authentication)}.
     */
