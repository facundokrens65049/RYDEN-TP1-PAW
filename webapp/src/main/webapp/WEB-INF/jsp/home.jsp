        ...
        <style>
            * {
            ...
            body {
                ...
                background-color: ***REMOVED***f0f0f0;
                color: ***REMOVED***333;
            }
            .container {
                max-width: 1200px;
            ...
            .example-title {
                ...
                border-bottom: 2px solid ***REMOVED***ccc;
            }
            .page-header { margin-bottom: 5rem; }
            .page-title { font-size: 2rem; font-weight: bold; margin: 0 0 0.25rem 0; }
            .page-subtitle { font-size: 1rem; color: ***REMOVED***666; margin: 0 0 1rem 0; }
            .page-separator { border: 0; border-top: 2px solid ***REMOVED***ccc; margin: 0 0 1.5rem 0; }
            ...
            .demo-size-label { font-size: 0.9rem; color: ***REMOVED***666; margin-bottom: 0.5rem; line-height: 1.2; min-height: 1.2em; flex-shrink: 0; }
