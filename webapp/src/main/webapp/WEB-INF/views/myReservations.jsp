...
<main class="container pt-5 pb-4">
    ...
    <ul class="nav nav-tabs mb-4" role="tablist">
        <li class="nav-item" role="presentation">
            <button class="nav-link ${selectedReservationsTab eq 'rider' ? 'active' : ''}" id="rider-tab" data-bs-toggle="tab" data-bs-target="***REMOVED***rider-pane" type="button" role="tab" aria-controls="rider-pane" aria-selected="${selectedReservationsTab eq 'rider' ? 'true' : 'false'}">
                <spring:message code="myReservations.section.myReservations"/>
            </button>
        </li>
        <li class="nav-item" role="presentation">
            <button class="nav-link ${selectedReservationsTab eq 'owner' ? 'active' : ''}" id="owner-tab" data-bs-toggle="tab" data-bs-target="***REMOVED***owner-pane" type="button" role="tab" aria-controls="owner-pane" aria-selected="${selectedReservationsTab eq 'owner' ? 'true' : 'false'}">
