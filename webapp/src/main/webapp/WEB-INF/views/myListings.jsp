        ...
        <div class="container pt-5 pb-4">
            ...
            <ul class="nav nav-tabs mb-4" role="tablist">
                <li class="nav-item" role="presentation">
                    <button class="nav-link ${selectedListingsTab eq 'listings' ? 'active' : ''}" id="listings-tab" data-bs-toggle="tab" data-bs-target="***REMOVED***listings-pane" type="button" role="tab" aria-controls="listings-pane" aria-selected="${selectedListingsTab eq 'listings' ? 'true' : 'false'}">
                        <spring:message code="myListings.tab.listings"/>
                    </button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link ${selectedListingsTab eq 'reservations' ? 'active' : ''}" id="reservations-tab" data-bs-toggle="tab" data-bs-target="***REMOVED***reservations-pane" type="button" role="tab" aria-controls="reservations-pane" aria-selected="${selectedListingsTab eq 'reservations' ? 'true' : 'false'}">
                                            ...
                                            <c:if test="${not empty car.statusKey}">
                                                <c:choose>
                                                    <c:when test="${car.statusKey == 'ACTIVE'}">
                                                        <span class="position-absolute top-0 end-0 m-3" style="background-color:***REMOVED***198754; color:***REMOVED***ffffff; padding:.25rem .5rem; border-radius:.375rem; font-weight:600; font-size:.75rem;">
                                                            <spring:message code="enum.listing.status.ACTIVE"/>
                                                        </span>
                                                    </c:when>
                                                    <c:when test="${car.statusKey == 'PAUSED'}">
                                                        <span class="position-absolute top-0 end-0 m-3" style="background-color:***REMOVED***e4960b; color:***REMOVED***ffffff; padding:.25rem .5rem; border-radius:.375rem; font-weight:600; font-size:.75rem;">
                                                            <spring:message code="enum.listing.status.PAUSED"/>
                                                        </span>
                                                    </c:when>
                                                    <c:when test="${car.statusKey == 'FINISHED'}">
                                                        <span class="position-absolute top-0 end-0 m-3" style="background-color:***REMOVED***6c757d; color:***REMOVED***ffffff; padding:.25rem .5rem; border-radius:.375rem; font-weight:600; font-size:.75rem;">
                                                            <spring:message code="enum.listing.status.FINISHED"/>
                                                        </span>
                                                    </c:when>
                                                    <c:when test="${car.statusKey == 'PAUSED_DUE_TO_LACK_OF_CBU'}">
                                                        <span class="position-absolute top-0 end-0 m-3" style="background-color:***REMOVED***b91c1c; color:***REMOVED***ffffff; padding:.25rem .5rem; border-radius:.375rem; font-weight:600; font-size:.75rem;">
