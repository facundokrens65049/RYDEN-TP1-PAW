...
<head>
    ...
    <style>
        ...
        .step-box {
            flex: 1;
            min-width: 110px;
            background: linear-gradient(135deg, var(--color-surface, ***REMOVED***f8f9fa) 0%, ***REMOVED***fff 100%);
            border: 2px solid var(--color-border, ***REMOVED***e9ecef);
        ...
        .step-number {
            font-size: 1.5rem;
            font-weight: bold;
            color: var(--color-primary, ***REMOVED***3b7be0);
            margin-bottom: 0.5rem;
        }

        .step-text {
            font-size: 0.875rem;
            color: var(--color-text, ***REMOVED***333);
            font-weight: 500;
            line-height: 1.4;
        }
