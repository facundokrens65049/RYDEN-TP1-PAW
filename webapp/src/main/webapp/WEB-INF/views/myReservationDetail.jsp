                    ...
                    <div class="card-body p-4">
                        ...
                        <form:form modelAttribute="ownerReviewForm" action="${ownerReviewUrl}" method="post"
                            ...
                            <div class="ryden-star-rating" data-target="ownerReviewRating">
                                <span class="ryden-star" data-value="1">&***REMOVED***9733;</span>
                                <span class="ryden-star" data-value="2">&***REMOVED***9733;</span>
                                <span class="ryden-star" data-value="3">&***REMOVED***9733;</span>
                                <span class="ryden-star" data-value="4">&***REMOVED***9733;</span>
                                <span class="ryden-star" data-value="5">&***REMOVED***9733;</span>
                            </div>
