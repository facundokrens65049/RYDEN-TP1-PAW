                ...
                <div class="card-body p-4">
                    ...
                    <div class="d-flex flex-column gap-3 px-2">
                        ...
                        <form method="post" action="<c:out value='${toggleListingUrl}'/>">
                            ...
                            <c:choose>
                                <c:when test="${statusKey == 'ACTIVE'}">
                                    <button type="submit" class="btn w-100" style="background-color:***REMOVED***e4960b; color:***REMOVED***ffffff; border-color:rgb(228 150 11);" aria-label="<spring:message code='myListingDetail.actions.pause'/>">
