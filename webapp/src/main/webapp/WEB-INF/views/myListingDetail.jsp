                        ...
                        <form method="post" action="<c:out value='${toggleListingUrl}'/>">
                            ...
                            <c:choose>
                                <c:when test="${statusKey == 'ACTIVE'}">
                                    <button type="submit" class="btn w-100" style="background-color:***REMOVED***e4960b; color:***REMOVED***ffffff; border-color:***REMOVED***e4960b;" aria-label="<spring:message code='myListingDetail.actions.pause'/>">
