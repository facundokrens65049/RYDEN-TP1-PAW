                    ...
                    <div class="d-flex flex-column gap-3 px-2">
                        ...
                        <c:choose>
                            <c:when test="${statusKey == 'ACTIVE'}">
                                ...
                                <button type="button" class="btn w-100" style="background-color:***REMOVED***e4960b; color:***REMOVED***ffffff; border-color:rgb(228 150 11);" data-modal-open="pauseListingModal" aria-label="<c:out value='${pauseBtnLabel}'/>">
