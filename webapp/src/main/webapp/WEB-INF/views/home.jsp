...
<html lang="en">
    ...
    <body>
        ...
        <div>
            ...
            <div class="sticky-top w-100 pt-2" style="top: 55px; z-index: 1020; background-color: ***REMOVED***f9fbff;">
                ...
                <section class="features-section mt-5 pt-5 pb-5 border-top border-secondary-subtle text-center" id="whyChooseUsSection">
                    ...
                    <div class="row g-4">
                        <div class="col-12 col-md-6 col-lg-3">
                            <div class="mb-3 d-inline-flex align-items-center justify-content-center rounded-circle" style="width: 72px; height: 72px; background-color: var(--color-primary-soft, ***REMOVED***eef4ff); color: var(--color-primary, ***REMOVED***3b7be0);">
            ...
            <section class="cta-banner text-center text-white py-5 w-100" style="background-color: var(--color-primary, ***REMOVED***3b7be0);">
