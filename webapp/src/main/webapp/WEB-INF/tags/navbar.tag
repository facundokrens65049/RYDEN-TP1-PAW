        ...
        <div class="d-flex flex-row justify-content-end align-items-center">
            ...
            <div class="dropdown-center text-end ms-2 me-3 py-1">
                ...
                <ul class="dropdown-menu dropdown-menu-end text-small">
                    ...
                    <li><a class="dropdown-item" href="***REMOVED***"><i class="bi bi-person me-2"></i>My profile</a></li>
                    <li><a class="dropdown-item" href="***REMOVED***"><i class="bi bi-calendar me-2"></i>My reservations</a></li>
                    <li><a class="dropdown-item" href="***REMOVED***"><i class="bi bi-car-front-fill me-2"></i>My cars</a></li>
                    <li><a class="dropdown-item" href="***REMOVED***"><i class="bi bi-gear me-2"></i>Settings</a></li>
                    <li><hr class="dropdown-divider" /></li>
                    <li><a class="dropdown-item text-danger" href="***REMOVED***"><i class="bi bi-box-arrow-right me-2"></i>Sign out</a></li>
                </ul>
            </div>
        </div>
    </div>
