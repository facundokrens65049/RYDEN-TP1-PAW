            ...
            <div class="modal-body p-0">
                <div id="${carouselId}" class="carousel slide" data-bs-ride="false">
                    ...
                    <c:if test="${not empty imageUrls}">
                        <button class="carousel-control-prev" type="button" data-bs-target="***REMOVED***${carouselId}" data-bs-slide="prev">
                            <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                            <span class="visually-hidden"><spring:message code="common.previous"/></span>
                        </button>
                        <button class="carousel-control-next" type="button" data-bs-target="***REMOVED***${carouselId}" data-bs-slide="next">
