...
public interface ReservationService {
    ...
    /**
     * Rider reservation from the web form: validate {@code riderId}, listing/dates/availability, then {@link ***REMOVED***createReservation}.
     *
     ...
     * {@link ar.edu.itba.paw.models.domain.Reservation.Status***REMOVED***CANCELLED_DUE_TO_MISSING_PAYMENT_PROOF}. Prefer
     * {@link ***REMOVED***cancelReservationAsParticipant(long, long)} for user-initiated cancellations.
     */
    ...
    /** Same as {@link ***REMOVED***findBlockingReservationsByListingId(long)} for a batch of listings. */
