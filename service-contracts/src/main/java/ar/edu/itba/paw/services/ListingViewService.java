...
public interface ListingViewService {
    ...
    /**
     * Same as {@link ***REMOVED***formatFullPickupLocation(Listing)} when pickup and return share one address line.
     */
    ...
    /**
     * Return leg: full line for owner or rider after proof; otherwise same as {@link ***REMOVED***formatPublicDeliveryLocation(Listing)}.
     */
    String formatDeliveryForReservationView(Listing listing, Reservation reservation, boolean viewerIsOwner);

    /**
     * Pickup line: full address for owner or rider after proof; otherwise same as {@link ***REMOVED***formatPublicPickupLocation(Listing)}.
     */
