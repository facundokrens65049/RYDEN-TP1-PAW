...
public final class ListingAddressFormatter {
    ...
    /**
     * Return leg for public contexts: same rules as {@link ***REMOVED***formatPublicPickupLocation(Listing)} when pickup and return share one place.
     *
    ...
    /**
     * Return leg for trusted contexts: same line as {@link ***REMOVED***formatFullPickupLocation(Listing)} when pickup and return share one place.
     *
     * @param listing listing whose start point defines the address
