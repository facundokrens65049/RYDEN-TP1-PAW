 ...
 * Other screens use {@link ***REMOVED***getDefaultPageSize()} as the SQL/UI page size (single-layer pagination).
 */
@Component
public final class PaginationPolicy {
    ...
    /** Items per UI page for home search-style grids (paired with {@link ***REMOVED***getDbFetchSize()} for SQL windows). */
