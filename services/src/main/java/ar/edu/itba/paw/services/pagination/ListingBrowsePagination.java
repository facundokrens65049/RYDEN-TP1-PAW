...
public final class ListingBrowsePagination {
     ...
     * @param uiPageSizeOrZero    if ≤ 0, {@link PaginationPolicy***REMOVED***getUiPageSize()} is used
     */
     ...
     * @param pageSizeOrZero     if ≤ 0, {@link PaginationPolicy***REMOVED***getDefaultPageSize()} is used
     */
