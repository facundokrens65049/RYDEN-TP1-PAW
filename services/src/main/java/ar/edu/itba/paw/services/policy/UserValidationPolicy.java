 ...
 * <p>
 * Instances are obtained via {@link ***REMOVED***fromValidatedConfiguration(int, int, int, int, int, int, String)} so invariants are
...
public final class UserValidationPolicy {
    ...
    /** Canonical constructor; use {@link ***REMOVED***fromValidatedConfiguration(int, int, int, int, int, int, String)} from outside. */
