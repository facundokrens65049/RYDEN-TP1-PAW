...
public final class PresentationLimitsPolicy {
    ...
    /** When {@link ***REMOVED***COUNTERPARTY_RECENT_REVIEWS} is unset or invalid. */
    private static final int FALLBACK_COUNTERPARTY_RECENT_REVIEWS_LIMIT = 3;
    /** When {@link ***REMOVED***CAR_DETAIL_SIMILAR_LISTINGS} is unset or invalid. */
    private static final int FALLBACK_CAR_DETAIL_SIMILAR_LISTINGS_LIMIT = 4;
    /** When {@link ***REMOVED***COUNTERPARTY_OWNER_ACTIVE_LISTINGS_PAGE} is unset or invalid. */
