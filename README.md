...
***REMOVED******REMOVED******REMOVED*** Environment properties (required)
...
***REMOVED******REMOVED*** Build and run (from repository root)
...
***REMOVED******REMOVED*** Deployed log files (HTTP)
